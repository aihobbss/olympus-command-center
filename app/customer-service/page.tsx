...
import { customerCases, type CustomerCase } from "@/data/mock";
...
export default function CustomerServicePage() {
  ...
  useEffect(() => {
    if (selectedCase && !(selectedCase.id in responseTexts)) {
      setResponseTexts((prev) => ({
        ...prev,
        [selectedCase.id]: selectedCase.suggestedResponse,
      }));
    }
    setSent(false);
    setSending(false);
  ...
  const currentResponse = selectedCase
    ? responseTexts[selectedCase.id] ?? selectedCase.suggestedResponse
    : "";
          ...
          {selectedCase ? (
            <>
              ...
              <div className="px-5 py-4 border-b border-subtle">
                ...
                <div className="rounded-lg bg-white/[0.02] border border-subtle px-4 py-3">
                  <p className="text-sm text-text-secondary whitespace-pre-line leading-relaxed">
                    {selectedCase.fullMessage}
                  </p>
                </div>
              </div>
